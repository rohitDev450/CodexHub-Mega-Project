           ...
           <NavBar/>
            <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 dark:bg-slate-900 dark:text-white">
                ...
                <div className="mx-auto max-w-2xl text-center ">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-white">Contact US</h2>
                    <p className="mt-2 text-lg leading-8 text-gray-600 dark:text-white">
                        Contact us for more interesting offers and features in latest features book.
                    </p>
                </div>
                <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20 ">
                    <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2 dark:text-white">
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <div className="relative mt-2.5">
                                <div className="absolute inset-y-0 left-0 flex items-center dark:text-white">
                        ...
                        <Switch.Group as="div" className="flex gap-x-4 sm:col-span-2 dark:text-white">
                    ...
                    <div className="mt-10">
                        <button
                            type="submit"
                            className=" dark:text-white block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                        >
                            Let's talk
                        </button>
                    </div>
